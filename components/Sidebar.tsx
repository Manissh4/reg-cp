...
const navItems = [
  ...
  },
  {
    ...
    icon: <Image src={"/medal-star.png"} alt="home" width={24} height={24} />,
    href: "/resolved",
  },
  {
    label: "Review Meeting",
    icon: <Image src={"/people.png"} alt="home" width={24} height={24} />,
    href: "/review-meet",
  },
];
            ...
            <Link href={item.href} key={item.label}>
              <div
                className={`flex items-center gap-2 cursor-pointer transition-all pl-2
                  ${
                    isActive
                      ? "bg-white rounded-tr-[12px] rounded-br-[12px] py-2.5"
                      : ""
                  }
                `}
